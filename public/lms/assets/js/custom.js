(function ($) {
    ...
    $(document).on("click", ".status-change", function (e) {
        ...
        // Prevent immediate change to wait for confirmation
        e.preventDefault();

        Swal.fire({
            title: warningLanguage,
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == "success") {
                            // Manually set the property since we prevented default
                    ...
                    error: function () {
                        Command: toastr["error"](`Status change failed.`);
                    }
                });
            }
        });
