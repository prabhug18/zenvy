    ...
    public function run(): void
    {
        $emilTemplates = [
            ...
            [
                ...
                'description' => '<p>Hello [user_name],</p><p>A new live class has been scheduled for the course: <b>[course_title]</b>.</p><p><b>Meeting ID:</b> [meeting_id]</p><p><b>Date:</b> [meeting_date]</p><p><b>Time:</b> [meeting_time]</p><p>Please be on time. See you there!</p><p>Thanks,<br>[app_name]</p>',
            ],
        ];
