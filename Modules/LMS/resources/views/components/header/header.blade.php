@php
    ...
    $rightActionsWrapperClass = $data['right_actions_wrapper_class'] ?? 'flex items-center gap-5';
...
<header class=" {{ $headerClass }} ">
    <div class="container">
        ...
        <div class="flex items-center justify-between">
            ...
            <!-- ACTIONS -->
            <div class="flex-1 flex items-center justify-end {{ $rightActionsWrapperClass }}">
                <!-- SEARCH -->
