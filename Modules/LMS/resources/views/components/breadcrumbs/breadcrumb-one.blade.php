...
<div class="{{ $wrapperClass }} relative overflow-hidden mb-16 sm:mb-24 lg:mb-[120px]">
    <div class="container py-[70px] relative z-10">
        ...
        <!-- BREADCRUMB -->
        <ul class="flex items-center bg-white px-4 py-3 lg:px-6 lg:py-3.5 mx-0 lg:mx-3 gap-1.5 *:flex-center *:gap-1.5 leading-none absolute bottom-0 left-1/2 -translate-x-1/2 lg:left-auto rtl:lg:left-0 lg:right-0 rtl:lg:right-auto lg:translate-x-0 rounded-t-2xl w-max shadow-sm border border-b-0 border-heading/5">
            <li
    ...
    <ul class="z-0">
        <!-- LEFT -->
        <li class="block size-[550px] w-[33.33vw] rounded-50 {{ $blobLeft }} blur-[180px] absolute top-1/2 -translate-y-1/2 -left-[10%] rtl:left-auto rtl:-right-[10%] -z-10"></li>
        <!-- CENTER -->
        <li class="block size-[550px] w-[33.33vw] rounded-50 {{ $blobCenter }} blur-[180px] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 -z-10"></li>
        <!-- RIGHT -->
        <li class="block size-[550px] w-[33.33vw] rounded-50 {{ $blobRight }} blur-[180px] absolute top-1/2 -translate-y-1/2 -right-[10%] rtl:right-auto rtl:-left-[10%] -z-10"></li>
    </ul>
</div>
