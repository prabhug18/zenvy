...
<div id="questionViewList" tabindex="-1"
    class="fixed inset-0 z-modal flex-center w-full hidden">
    <div class="p-4 w-full max-w-3xl">
        <div class="relative bg-white dark:bg-dark-card-two rounded-lg dk-theme-card-square shadow overflow-hidden">
