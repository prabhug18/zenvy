...
<div
    ...
    <a href="{{ $route }}" class="group-data-[sidebar-size=lg]:block hidden">
        <img src="{{ $mainLogo }}" class="hidden group-[.light]:block max-w-[100px]" alt="main-logo" width="80" />
        <img src="{{ $darkLogo }}" class="hidden group-[.dark]:block max-w-[100px]" alt="dark-logo" width="80"/>
    </a>
