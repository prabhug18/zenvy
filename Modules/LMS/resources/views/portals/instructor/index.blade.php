...
<x-dashboard-layout>
    ...
    <div class="grid grid-cols-12 gap-x-4">
            ...
            <div class="rounded-15 overflow-hidden dk-theme-card-square">
                ...
                <div class="p-7 mt-6 text-center">
                    <h4 class="text-[22px] leading-none text-heading dark:text-white font-semibold">
                        {{ $translations['first_name'] ?? $user->first_name }}
                        {{ $translations['last_name'] ?? $user->last_name }}
                    </h4>
                    <p class="text-xs leading-none text-gray-500 dark:text-dark-text mt-1.5"> {{ authCheck()->email }}
                    </p>
                    <div
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <div class="text-sm leading-none text-gray-500 dark:text-dark-text">
                                {{ $data['total_course'] }} {{ translate('Courses') }}</div>
                        </div>
                    </div>
        ...
        @endif
        <!-- End Instructor Best Selling Course Table -->
    </div>
</x-dashboard-layout>
