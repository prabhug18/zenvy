...
class ReviewController extends Controller
{
    ...
    public function index()
    {
        ...
        $coursesId = authCheck()?->organizationCourses?->pluck('id')->toArray() ?? [];
        ...
        return view('portal::organization.review.course.index', compact('reviews'));
    }
    /**
     *  edit
     *
    ...
    public function edit($id)
    {
        ...
        return view('portal::organization.review.course.form', compact('review'));
    }
    ...
    public function update($id, Request $request): array|JsonResponse
    {
        ...
        return $this->jsonSuccess('Course review modify successfully!', route('organization.course-review.index'));
    }
    ...
    public function destroy(int $id, Request $request): JsonResponse
    {
        ...
        $response['url'] = route('organization.course-review.index');
