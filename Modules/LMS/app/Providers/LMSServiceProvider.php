...
class LMSServiceProvider extends ServiceProvider
{
    ...
    public function boot(Kernel $kernel): void
    {
        ...
        // Ensure 'languages' is bound early so views that call `app('languages')`
        // don't trigger a container attempt to resolve it as a class before
        // middleware runs. The closure will be executed when the binding is
        // resolved, so this is safe during boot.
        ...
        // $kernel->pushMiddleware(BootstrapMiddleware::class);
        $this->app['router']->aliasMiddleware('bootstrap', \Modules\LMS\Http\Middleware\BootstrapMiddleware::class);
        // $this->app['router']->pushMiddlewareToGroup('web', \Modules\LMS\Http\Middleware\BootstrapMiddleware::class);
    ...
    public function registerViews(): void
    {
        ...
        // Register portal views under the generic 'portal' namespace so views/components
        // referencing "portal::..." resolve correctly.
